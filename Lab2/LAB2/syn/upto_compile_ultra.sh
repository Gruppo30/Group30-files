...
elaborate FPmul -arch pipeline -lib WORK > ./results_compile_ultra/elaborate_noimpl.txt
uniquify
link
...
compile_ultra
report_timing
report_timing > ./results_compile_ultra/report_timing_noimpl.txt
report_area > ./results_compile_ultra/report_area_noimpl.txt
report_resources > ./results_compile_ultra/report_resources_noimpl.txt
