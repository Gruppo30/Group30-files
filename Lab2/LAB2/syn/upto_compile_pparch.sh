...
elaborate FPmul -arch pipeline -lib WORK > ./results/elaborate_pparch.txt
uniquify
link
...
compile
report_timing
report_timing > ./results/report_timing_pparch.txt
report_area > ./results/report_area_pparch.txt
report_resources > ./results/report_resources_pparch.txt
