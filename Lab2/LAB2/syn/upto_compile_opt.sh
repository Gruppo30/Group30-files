...
elaborate FPmul -arch pipeline -lib WORK > ./results_optimize_reg/elaborate_noimpl.txt
uniquify
link
create_clock -name MY_CLK -period 0.94 clk
...
optimize_registers
report_timing
report_timing > ./results_optimize_reg/report_timing_noimpl.txt
report_area > ./results_optimize_reg/report_area_noimpl.txt
report_resources > ./results_optimize_reg/report_resources_noimpl.txt
