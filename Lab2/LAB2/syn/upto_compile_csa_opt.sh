...
elaborate FPmul -arch pipeline -lib WORK > ./results_optimize_reg/elaborate_CSA.txt
uniquify
link
...
optimize_registers
report_timing
report_timing > ./results_optimize_reg/report_timing_CSA.txt
report_area > ./results_optimize_reg/report_area_CSA.txt
report_resources > ./results_optimize_reg/report_resources_CSA.txt
