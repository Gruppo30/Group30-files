...
# Created by write_sdc on Thu Oct 21 19:34:43 2021
...
create_clock [get_ports clk]  -name MY_CLK  -period 11.48  -waveform {0 5.74}
set_clock_uncertainty 0.07  [get_clocks MY_CLK]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports resn]
