...
analyze -f vhdl -lib WORK ../fpuvhdl/multiplier/FA.vhd
analyze -f vhdl -lib WORK ../fpuvhdl/multiplier/HA.vhd
analyze -f vhdl -lib WORK ../fpuvhdl/multiplier/product_gen.vhd
analyze -f vhdl -lib WORK ../fpuvhdl/multiplier/pj_gen.vhd
analyze -f vhdl -lib WORK ../fpuvhdl/multiplier/dadda_tree.vhd
analyze -f vhdl -lib WORK ../fpuvhdl/multiplier/MBE.vhd
set power_preserve_rtl_hier_names true
elaborate FPmul -arch pipeline -lib WORK > ./results/elaborate_noimpl.txt
uniquify
link
create_clock -name MY_CLK -period 1.00 clk
