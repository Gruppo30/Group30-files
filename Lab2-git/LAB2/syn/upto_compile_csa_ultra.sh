...
elaborate FPmul -arch pipeline -lib WORK > ./results_compile_ultra/elaborate_CSA.txt
uniquify
link
...
compile_ultra
report_timing
report_timing > ./results_compile_ultra/report_timing_CSA.txt
report_area > ./results_compile_ultra/report_area_CSA.txt
report_resources > ./results_compile_ultra/report_resources_CSA.txt
