...
elaborate FPmul -arch pipeline -lib WORK > ./results/elaborate_CSA.txt
uniquify
link
...
compile
report_timing
report_timing > ./results/report_timing_CSA.txt
report_area > ./results/report_area_CSA.txt
report_resources > ./results/report_resources_CSA.txt
